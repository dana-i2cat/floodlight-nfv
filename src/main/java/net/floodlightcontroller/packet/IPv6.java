...
/******************************NOT IMPLEMENTED YET****************************************/    
     ...
     */
    public IPv6 setDiffServ(byte diffServ) {
     ...
     */
    public IPv6 setIdentification(short identification) {
     ...
     */
    public IPv6 setFlags(byte flags) {
        this.flags = flags;
        return this;
    }
     ...
     */
    public IPv6 setFragmentOffset(short fragmentOffset) {
     ...
     */
    public IPv6 setProtocol(byte protocol) {
     ...
     */
    public IPv6 setChecksum(short checksum) {
    ...
    public IPv6 setSourceAddress(String sourceAddress) {
        this.sourceAddress = IPv6.toIPv4Address(sourceAddress);
        return this;
    }
    ...
    public IPv6 setDestinationAddress(String destinationAddress) {
        this.destinationAddress = IPv6.toIPv4Address(destinationAddress);
        return this;
    }
     ...
     */
    public IPv6 setOptions(byte[] options) {
    ...
    public IPacket deserialize(byte[] data, int offset, int length) {
        ...
        if (!isFragment && IPv6.protocolClassMap.containsKey(this.protocol)) {
            Class<? extends IPacket> clazz = IPv6.protocolClassMap.get(this.protocol);
            try {
